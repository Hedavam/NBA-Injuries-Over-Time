...
```{r ols-independence, eval=FALSE, echo=FALSE, fig.width=12, fig.height=10}
...
```{r ols-questionable-team-PACFs, echo=FALSE}
par(mfrow = c(2, 4))

questionable_team_PACFs <- c("Celtics", "Knicks", "Mavericks", "Nets", "Nuggets", "Pacers", "Raptors",
                             "Spurs", "Suns", "Wizards")
...
```{r gls-questionable-team-PACFs, echo=FALSE}
par(mfrow = c(2, 3))

questionable_team_PACFs <- c("Spurs", "Raptors", "Hawks", "Celtics", "Pelicans")
